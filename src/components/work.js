...
function GalleryImg(props) {
  return <a data-fancybox="gallery" href={props.url} aria-hidden="true"><span style={{display: 'none'}}>content</span></a>
}
    ...
    return (
      <section id="work" className="darken">
        <div className="container">
          <div className="row text-center header animate-in justify-content-center" data-anim-type="fade-in-up">
            <div className="col-12">
              <h3>{this.state.heading}</h3>
              <hr />
            </div>
          </div>
          <PortfolioColumns key={this.state.clients} clients={this.state.clients}/>
        </div>
      </section>
    )
  }
